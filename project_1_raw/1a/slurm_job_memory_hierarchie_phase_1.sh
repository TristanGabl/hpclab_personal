...
#SBATCH --output=slurm_job_memory_hierarchie_phase_1-%j.out               # Output file (default: slurm-%j.out)
#SBATCH --error=slurm_job_memory_hierarchie_phase_1-%j.err                # Error file  (default: slurm-%j.out)
