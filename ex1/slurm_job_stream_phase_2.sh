...
#SBATCH --output=slurm_job_stream_phase_2-%j.out               # Output file (default: slurm-%j.out)
#SBATCH --error=slurm_job_stream_phase_2-%j.err                # Error file  (default: slurm-%j.out)
