...
def main():
    ...
    for i,N in enumerate(Ns):
        ...
        plt.legend()
        if i == 0:
            plt.savefig("mini_app_openMP_benchmark_weak_base64.png")
        elif i == 1:
            plt.savefig("mini_app_openMP_benchmark_weak_base128.png")
        elif i == 2:
            plt.savefig("mini_app_openMP_benchmark_weak_base256.png")
